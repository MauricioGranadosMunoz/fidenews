            ...
            <HomeLayout hasHeader={true}>
                ...
                <div className='main-content animate__animated animate__fadeIn'>
                    ...
                    <Table striped bordered hover>
                        ...
                        <tbody>
                            <tr><td>Id usuario</td><td>Usuario</td><td><Nav.Link href="/">Editar</Nav.Link></td></tr>
                        </tbody>
                    </Table>
                </div>
                ...
                <InputGroup>
                    ...
                    <Table striped bordered hover>
                        ...
                        <tbody>
                            <tr><td>Id Noticia</td><td>Titulo Noticia</td><td><Nav.Link href="/">Editar</Nav.Link></td></tr>
                        </tbody>
                    </Table>
