...
CREATE TABLE ROLS (
   ...
   TIPO VARCHAR(20) NOT NULL CONSTRAINT UNQ_TIPO_ROL UNIQUE USING INDEX TABLESPACE TBS_USERS_IDX
...
CREATE TABLE NOTICIAS (
   ...
   TITULO VARCHAR2(200) NOT NULL CONSTRAINT UNQ_TITULO UNIQUE USING INDEX TABLESPACE TBS_NEWS_IDX,
