set serveroutput on
--USUARIOS---
CREATE OR REPLACE PROCEDURE SP_INSERT_UPDATE_USERS (USER_ID_V IN INTEGER,CORREO_V IN VARCHAR2,NOMBRE_V IN VARCHAR2,APELLIDOS_V IN VARCHAR2,ESTADO_V IN NUMBER,CONTRASENA_V IN VARCHAR2,ROL_ID_V IN INTEGER)    
AS
N1 INTEGER;
BEGIN  
...
CREATE OR REPLACE PROCEDURE SP_SELECT_USUARIOS (ESTADO_V IN INTEGER, display OUT SYS_REFCURSOR)  
IS  
BEGIN  
CASE
...
CREATE OR REPLACE PROCEDURE SP_DELETE_USUARIOS (USER_ID_V IN INTEGER)  
IS  
BEGIN  
...
---ROLS---
CREATE OR REPLACE PROCEDURE SP_INSERT_UPDATE_ROLS (ROL_ID_V IN INTEGER,TIPO_V IN VARCHAR2)    
AS
N1 INTEGER;
BEGIN  
...
CREATE OR REPLACE PROCEDURE SP_DELETE_ROLS (ROL_ID_V IN INTEGER)  
IS  
BEGIN  
...
CREATE OR REPLACE PROCEDURE SP_INSERT_UPDATE_REACCIONES (REACCION_ID_V IN INTEGER, TIPO_REACCION_V IN VARCHAR2,COMENTARIO_V IN VARCHAR, USER_ID_V IN INTEGER,NOTICIA_ID_V IN INTEGER)    
AS
N1 INTEGER;
BEGIN  
...
CREATE OR REPLACE PROCEDURE SP_SELECT_REACCIONES (TIPO_V IN VARCHAR2,display OUT SYS_REFCURSOR)  
IS  
BEGIN  
CASE
...
CREATE OR REPLACE PROCEDURE SP_DELETE_REACCIONES (REACCION_ID_V IN INTEGER)  
IS  
BEGIN  
...
CREATE OR REPLACE PROCEDURE SP_INSERT_UPDATE_NOTICIAS (NOTICIA_ID_V IN INTEGER,LINK_IMAGEN_V IN VARCHAR2,CATEGORIA_V IN VARCHAR2,DESCRIPCION_V IN VARCHAR2, TITULO_V IN VARCHAR2,USER_ID_V IN INTEGER)    
AS
N1 INTEGER;
BEGIN  
